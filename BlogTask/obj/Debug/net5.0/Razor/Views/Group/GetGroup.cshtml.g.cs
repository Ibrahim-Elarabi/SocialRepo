#pragma checksum "D:\Courses\Core\Social Project\V4\BlogTask\BlogTask\Views\Group\GetGroup.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "68f597256f67e2c766521c29a736e04be85a9b40"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"68f597256f67e2c766521c29a736e04be85a9b40", @"/Views/Group/GetGroup.cshtml")]
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "68f597256f67e2c766521c29a736e04be85a9b405793", async() => {
            }
            );
...
#nullable disable
    ...
    function GetPostsIngroup(id,pageIndex) {
        ...
        $.ajax({
            type: ""Get"",
            url: '/Post/GetPostsInGroup?id=' + id,
            data: {
                ""pageIndex"": pageIndex
            },
            success: (res) => {
    ...
    function getSearchForm(id) {
        $.ajax({
            ...
            error: (res) => {
                ");
            WriteLiteral("$(\"#searchSection\").html(\"Can\'t load Form Section\");\r\n\r\n            }\r\n        })\r\n\r\n    }\r\n</script>");
        }
